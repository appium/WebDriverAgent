...
{
  NSError *error;
  XCTAssertFalse([XCUIDevice.sharedDevice fb_pressButton:@"volumeUpp" forDuration:nil error:&error]);
...
{
  NSError *error;
  XCTAssertTrue([XCUIDevice.sharedDevice fb_pressButton:@"home" forDuration:nil error:&error]);
  XCTAssertNil(error);
}
