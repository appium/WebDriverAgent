...
{
  // Probably this returns always nil? since no "XCAccessibilityElement" in XCTest header duump.
  // Some dumpls has reference, so they could be only private.
  // Let me return always nil...
  return nil;
}
