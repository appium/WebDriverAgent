...
class WebDriverAgent {
  constructor (xcodeVersion, args = {}, log = null) {
    ...
    this.doNotAppendXctrunner = args.doNotAppendXctrunner
  ...
  get bundleIdForXctest () {
    if (this.updatedWDABundleId && this.doNotAppendXctrunner) {
      return this.updatedWDABundleId ? this.updatedWDABundleId : WDA_RUNNER_BUNDLE_ID;
    }
  ...
  async _cleanupProjectIfFresh () {
    if (this.canSkipXcodebuild || this.prebuildWDA) {
      return;
    }
