...
class WebDriverAgent {
  ...
  get bundleIdForXctest () {
    if (this.updatedWDABundleId) {
      return `${this.updatedWDABundleId}${this.doNotAddXctrunnerSuffix ? '' : '.xctrunner'}`;
    }
    return `${this.doNotAddXctrunnerSuffix ? WDA_RUNNER_BUNDLE_ID : WDA_RUNNER_BUNDLE_ID_FOR_XCTEST}`;
  }
