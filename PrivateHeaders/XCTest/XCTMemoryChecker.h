...
- (void)assertNoLeaksInProcessWithIdentifier:(int)arg1 withOptions:(long long)arg2 inScope:(CDUnknownBlockType)arg3;
...
- (void)_assertNoLeaksInProcessWithIdentifier:(int)arg1 withOptions:(long long)arg2 inScope:(CDUnknownBlockType)arg3;
